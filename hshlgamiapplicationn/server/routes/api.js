...
//const db= "mongodb://localhost:27017/hshlgamidb";
...
router.put('/profile/user/:id', function(req, res){
    console.log('Update a student');
    MyStudents.findByIdAndUpdate(req.params.id,
    {
        $set: {name: req.body.name, surname: req.body.surname, address: req.body.address, phoneNumber: req.body.phoneNumber}
